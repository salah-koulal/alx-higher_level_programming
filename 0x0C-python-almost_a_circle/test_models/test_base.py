...
class TestBase(unittest.TestCase):
    ...
    def test_id_not_given(self):
        """Test ids match incremented nb_obj when not given"""
    ...
    def test_none_to_json_string(self):
        """Test no dict given translates into JSON str of empty dict"""
        d2 = None
    ...
    def test_empty_to_json_string(self):
        """Test empty dict given translates into JSON str of empty dict"""
        d3 = dict()
    ...
    """Test creating instance from a dictionary"""
    ...
    """Test saving JSON str repr of dict to class specific file"""
    ...
    def test_save_none_to_file(self):
        """Test save None to a file"""
        Rectangle.save_to_file(None)
        with open("Rectangle.json", "r") as file:
            self.assertEqual('[]', file.read())

    def test_empty_none_to_file(self):
        """Test save empty list to a file"""
